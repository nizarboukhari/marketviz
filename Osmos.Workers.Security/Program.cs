...
namespace Osmos.Workers.Security
{
    class Program
    {
        static void Main()
        {
            ProgramConfigurationBuilder.BuildMain<SecurityApp>(ConfigureServices);
        }

        private static void ConfigureServices(IServiceCollection services)
        {
            var configuration = ProgramConfigurationBuilder.BuildConfiguration<SecurityApp>(services);
