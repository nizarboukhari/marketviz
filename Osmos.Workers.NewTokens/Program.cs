...
namespace Osmos.Workers.NewTokens
{
    class Program
    {
        static void Main()
        {
            ProgramConfigurationBuilder.BuildMain<NewTokensApp>(ConfigureServices);
        }

        private static void ConfigureServices(IServiceCollection services)
        {
            var configuration = ProgramConfigurationBuilder.BuildConfiguration<NewTokensApp>(services);
